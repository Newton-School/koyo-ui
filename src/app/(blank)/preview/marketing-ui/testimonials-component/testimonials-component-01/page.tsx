...
const testimonials: TestimonialItem[] = [
  {
    ...
    rating: 5,
    content: "I've been using Koyo UI for a year now and it's made managing my finances so much easier and quick."
  },
  {
    name: 'Martin Dorwart',
    ...
    rating: 4,
    content: "With Koyo UI, I can easily track my investments and see how they're performing in real-time."
  },
  {
    name: 'Sarah Johnson',
    role: 'Lead Designer',
  ...
  },
  {
    ...
    rating: 4,
    content:
      'Koyo UI has saved us countless hours in development. The component library is comprehensive and well-documented.'
  }
]
