...
export const metadata: Metadata = {
  title: {
    template: '%s - Koyo UI',
    default: 'Koyo UI - Component Library'
  },
  description:
    'A Koyo component library built from shadcn/ui patterns, copy-friendly docs, and Koyo Figma design tokens.',
  keywords: ['koyo ui', 'koyo components', 'shadcn ui', 'shadcn/ui', 'component library'],
  icons: {
    icon: [
