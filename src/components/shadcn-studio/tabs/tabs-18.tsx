        ...
        <TabsList className='bg-background h-full flex-col'>
          {tabs.map(tab => (
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className='data-[state=active]:border-koyo-button-primary data-[state=active]:bg-koyo-button-primary data-[state=active]:text-koyo-button-primary-foreground data-[state=active]:hover:bg-koyo-button-primary-hover w-full'
            >
              {tab.name}
            </TabsTrigger>
          ))}
