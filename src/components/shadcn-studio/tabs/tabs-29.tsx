        ...
        <TabsList className='bg-background relative rounded-none border-b p-0'>
          {tabs.map((tab, index) => (
            <TabsTrigger
              ...
              className='bg-background data-[state=active]:bg-background data-[state=active]:text-koyo-button-primary relative z-10 rounded-none border-0 data-[state=active]:shadow-none'
            >
              {tab.name}
            </TabsTrigger>
          ))}
          ...
          <motion.div
            className='bg-koyo-button-primary absolute bottom-0 z-20 h-0.5'
            layoutId='underline'
            style={{
