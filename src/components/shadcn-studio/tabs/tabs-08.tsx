        ...
        <TabsList className='bg-background'>
          {tabs.map(tab => (
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className='data-[state=active]:border-koyo-button-primary/20 data-[state=active]:bg-koyo-button-primary/15 data-[state=active]:text-koyo-button-primary data-[state=active]:shadow-none'
            >
              {tab.name}
            </TabsTrigger>
          ))}
