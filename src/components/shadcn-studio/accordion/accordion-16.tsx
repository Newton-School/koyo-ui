          ...
          <AccordionContent className='pb-0'>
            {item.faqs.map((faq, index) => (
              <Collapsible key={index} className='bg-muted border-t px-8' defaultOpen={faq.open}>
                <CollapsibleTrigger className='focus-visible:ring-ring/50 flex w-full items-center gap-4 rounded-lg py-4 font-medium outline-none focus-visible:z-10 focus-visible:ring-[3px] [&>svg>path:last-child]:origin-center [&[data-state=open]>svg]:rotate-180 [&[data-state=open]>svg>path:last-child]:rotate-90 [&[data-state=open]>svg>path:last-child]:opacity-0'>
