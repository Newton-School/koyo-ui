        ...
        <SidebarContent>
          <SidebarGroup className={cn('px-3 pt-0 pb-4 last:pb-8 lg:px-5', { 'first:pt-8': !isBreakpointReached })}>
            <SidebarMenu className='gap-2.5'>
              <CustomSidebarMenuItem href='/docs/koyo'>
              ...
              <CustomSidebarMenuItem
                href='https://www.figma.com/design/vZxsTXFjBdz8iDED2qnDG6/Shadcn-ui-kit?node-id=273-30617&t=3oPZ5l5Xd5warA0M-4'
                openInNewTab
              >
                <Figma className='!size-5' />
                Koyo Figma File
              </CustomSidebarMenuItem>
              <CustomSidebarMenuItem href='/docs/getting-started/introduction'>
