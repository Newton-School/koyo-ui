    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogHeader className='sr-only'>
          ...
          <DialogDescription>Search Koyo UI docs, components, and blocks.</DialogDescription>
        </DialogHeader>
        <DialogContent className='overflow-hidden p-0'>
          ...
          >
            <CommandInput placeholder='Search Koyo UI...' value={search} onValueChange={setSearch} />
            <CommandList>
              ...
              {search ? (
                ...
                <CommandGroup heading='Suggestions'>
                  <CommandItem onSelect={() => runCommand(() => router.push('/docs/koyo'))}>
                    <Component />
                    <span>Koyo Component Catalog</span>
                  </CommandItem>
