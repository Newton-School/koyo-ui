  ...
  ({ children, className, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          'group animate-rainbow text-primary-foreground focus-visible:ring-koyo-button-primary-ring relative inline-flex size-9 cursor-pointer items-center justify-center rounded-lg border-2 border-transparent bg-[length:200%] [background-clip:padding-box,border-box,border-box] [background-origin:border-box] font-medium transition-colors focus-visible:ring-[3px] focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
